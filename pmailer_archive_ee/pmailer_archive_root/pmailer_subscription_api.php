...
class PMailerSubscriptionApiV1_0
{
	...
	function getBatch($filters = array(), $order = array(), $page, $limit)
    {
		$success =
            $this->_xml_rpc->query(
                'messages.getBatch',
    ...
    function createBatch($contacts = array(), $list_ids = array(), $subscription_status, $action = 'update')
	{
		$success =
            $this->_xml_rpc->query(
	...
	function getLists($filter = array(), $order = array(), $start = 1, $limit = 50)
    {
        $success =
            $this->_xml_rpc->query(
                'lists.getBatch',
